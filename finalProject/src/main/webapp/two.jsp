                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-3 col-1680-4">
                           <div class="offers_image_container">
                              ...
                              <div class="offers_image_background" style="float:left;"><img class="offers_image_background" style src="resources/roomImg/1.jpg" id=stImg></div>
                        ...
                        <div class="col-lg-3 col-1680-4">
                           <div class="offers_image_container">
                              <!-- Image by https://unsplash.com/@itsnwa -->
                               <div class="offers_image_background" style="float:left;"><img class="offers_image_background" style src="resources/roomImg/3.jpg" id=prImg></div>
                           </div>
                        </div>
                        <div class="col-lg-8">
                           <div class="offers_content">
